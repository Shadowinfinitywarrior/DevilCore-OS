...
static const uint8_t font8x8[128][8] = {
    ...
    [50] = {0x3C,0x66,0x06,0x3C,0x60,0x66,0x7E,0x00}, // 2
    [51] = {0x3C,0x66,0x06,0x1C,0x06,0x66,0x3C,0x00}, // 3
    [52] = {0x1C,0x3C,0x6C,0xCC,0xFE,0x0C,0x0C,0x00}, // 4
    ...
    [81] = {0x3C,0x66,0x66,0x66,0x66,0x7C,0x3E,0x00}, // Q
    ...
    [87] = {0x63,0x63,0x6B,0x7F,0x77,0x63,0x63,0x00}, // W
    ...
    [106]= {0x0C,0x00,0x1C,0x0C,0x0C,0x4C,0x38,0x00}, // j
    ...
    [62] = {0x00,0x18,0x0C,0x06,0x0C,0x18,0x00,0x00}, // >
    [95] = {0x00,0x00,0x00,0x00,0x00,0x00,0xFF,0x00}, // _
    [126]= {0x00,0x00,0x3A,0x6E,0x00,0x00,0x00,0x00}, // ~
    [64] = {0x3C,0x66,0x6E,0x6E,0x60,0x66,0x3C,0x00}, // @
    [36] = {0x18,0x7E,0x60,0x3C,0x06,0x7E,0x18,0x00}, // $
};
